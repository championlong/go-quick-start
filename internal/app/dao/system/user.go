...
func (u *user) Initialize() error {
	entities := []system.SysUser{
		...
		{UUID: uuid.NewV4(), Username: "a303176530", Password: "3ec063004a6f31642261936a379fde3d", NickName: "QMPlusUser", HeaderImg: "https:///qmplusimg.henrongyi.top/1572075907logo.png", AuthorityId: 528, Phone: "17611111111", Email: "333333333@qq.com"},
	}

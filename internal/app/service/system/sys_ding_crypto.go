...
var dingTalkCrypto *DingTalkCrypto

func GetDingTalkCrypto() *DingTalkCrypto {
	if dingTalkCrypto == nil {
		dingTalkCrypto = NewDingTalkCrypto(token, encodingAESKey, suiteKey) // 不是并发安全的
	}
